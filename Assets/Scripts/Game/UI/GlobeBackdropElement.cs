...
namespace Nation.Game.UI
{
    ...
    /// Drawn with Painter2D so it costs no textures and scales to any resolution. The real textured Earth
    /// replaces it in the world map phase; this keeps the first build looking intentional.
    /// </summary>
